void main() {
  ...
  // Mendefinisikan list 'nav' dengan kondisi menggunakan 'if' berdasarkan nilai 'promoActive'.
  var nav = ['Home', 'Furniture', 'Plants', if (promoActive) 'Outlet'];
  print(nav);

  // Mendefinisikan variabel 'login' dengan nilai 'Manager'.
  var login = 'Manager';

  // Mendefinisikan list 'nav2' dengan kondisi menggunakan 'if' berdasarkan nilai 'login'.
  var nav2 = [
    'Home',
    'Furniture',
    'Plants',
